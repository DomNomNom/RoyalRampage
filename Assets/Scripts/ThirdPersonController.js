...
private var fovDistorter : FovDistorter = null;
...
function Awake () {
    ...
    fovDistorter = GetComponentInChildren(FovDistorter);
...
function Update() {
    ...
    //     if (pickupTruck && Vector3.Distance(pickupTruck.transform.position, transform.position) < 5.0) {
    //         Destroy(pickupTruck);
    //         pickupTruck = null;
    //     }
    // }
